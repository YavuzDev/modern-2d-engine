...
![Alt Text](https://i.imgur.com/P28STTX.gif)
...
![Alt Text](https://i.imgur.com/AxT9AR8.gif)

# Setup

Clone the repository and open it in CLion. CLion will take care of the rest.
